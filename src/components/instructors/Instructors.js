                     ...
                     <div className = "titleAndTextBox" style = {{paddingTop: 10, paddingLeft: 30, paddingRight: 30, paddingBottom: 0}}>
                        ...
                        <div className = "titleAndContactBox">
                            ...
                            <div className = "contactFont" style = {{paddingLeft: 30, paddingTop:5}}>
                                    <p>email: sweetes0214@gmail.com ~ phone: 8056603003</p>
                 ...
                 <div className = "instructBox" style = {{paddingTop: 30, paddingLeft: 30, paddingRight: 30, paddingBottom:30}}>
                     ...
                     <div className = "titleAndTextBox" style = {{paddingTop: 10, paddingLeft: 30, paddingRight: 30, paddingBottom: 0}}>
                        ...
                        <div className = "titleAndContactBox">
                            ...
                            <div className = "contactFont" style = {{paddingLeft: 30, paddingTop:5}}>
                                    <p>email: tsub@gmail.com ~ phone: 8052350891</p>
                 ...
                 <div className = "instructBox" style = {{paddingTop: 30, paddingLeft: 30, paddingRight: 30, paddingBottom:30}}>
                     ...
                     <div className = "titleAndTextBox" style = {{paddingTop: 10, paddingLeft: 30, paddingRight: 30, paddingBottom: 0}}>
                        ...
                        <div className = "titleAndContactBox">
                         ...
                         <div className = "descriptFont" style = {{paddingTop: 20}}>
                         <p> Lucas Van Parys is a talented varsity tennis athlete who has been engaged in this sport since the age of four. Lucas is a versatile player. He often plays as the #3 starter for doubles and  he has expertise in both doubles and competitive singles. Lucas is able to provide valuable and meaningful instruction to WTA’s students. He is able to introduce a variety of unorthodox yet effective techniques. Off the court, Lucas enjoys working on his passion for scriptwriting and drawing. He attends journalism classes at Westlake and has even had several of his articles published in the school newspaper. 
                         </p>
                         </div>
